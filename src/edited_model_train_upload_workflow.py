...
get_ipython().system('robocopy kaggle.json ~/.kaggle/kaggle.json')


# In[6]:


get_ipython().system('kaggle datasets download ruolinzheng/twewy-game-script -f twewy-name-line-full.csv')


# In[7]:


data = pd.read_csv('new_trump.csv')
